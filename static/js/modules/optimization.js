...
// Version: 1.0.0
// Description: Step 10 — Design Space Optimization. Single-objective via
...
export async function initOptimization(containerEl) {
  ...
  if (!resultsResp.success || !resultsResp.results) {
    containerEl.innerHTML = `
      <div class="section-header">
        <h2 class="section-title">Step 10 — Design Space Optimization</h2>
      </div>
  ...
  header.innerHTML = `<h2 class="section-title">Step 10 — Design Space Optimization</h2>
