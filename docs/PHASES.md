...
## Milestone 4 — v4.0.0: Team Deployment, Auth, HPC Integration
...
**Backend:**
- `app/learning/datasets/` — 5 synthetic CSVs generated by a one-time script
- `app/learning/exercises/` — 5 exercise JSON files (replaces `placeholder.md`)
